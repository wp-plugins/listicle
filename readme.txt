...
Tags: lists, listicle, shortcode, SEO, post, page, paginate, pageviews
...
A sample shortcode with all its features:
	...
	[listicle name="sample listicle for readme"]
		...
		<li><b>The text inside the bold tags become the headline of the post generated by listicle.</b>  The text inside the list item, also available from the WYSIWYG becomes the content of the list item post.  If there is no headline specified using the "b" tag</li>
		
		<li>If there is no bold tag listicle will use the name attribute from the listicle shortcode to generate a numbered sequence of titles for the list item posts.  For example, this list item would be titled: sample listice for readme - 2.</li>

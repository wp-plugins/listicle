...
A sample shortcode with all its features:
	...
	[listicle name="sample listicle for readme"]
		...
		<li><b>title for this post</b>If there is no bold tag listicle will use the name attribute from the listicle shortcode to generate a numbered sequence of titles for the list item posts.  For example, this list item would be titled: sample listice for readme - 2.</li>
